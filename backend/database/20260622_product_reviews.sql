-- User-submitted product reviews with admin moderation
...
BEGIN
    ...
    CREATE INDEX ix_product_reviews_product_status ON dbo.product_reviews(product_id, status, created_at DESC);
