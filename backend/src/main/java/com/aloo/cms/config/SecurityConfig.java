    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/auth/profile/avatar").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/auth/password-change/request-otp").authenticated()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/chat/sessions/account").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/chat/sessions/mine").permitAll()
