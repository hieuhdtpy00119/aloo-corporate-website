  ...
  <section class="bg-avocado-50 px-4 py-10 sm:px-5 lg:px-6">
    <div class="mx-auto max-w-4xl space-y-6">
      <div class="rounded-2xl border border-avocado-100 bg-gradient-to-br from-white via-avocado-50 to-cream-100 p-6 shadow-sm">
        ...
        <h1 class="mt-2 text-3xl font-black text-avocado-950">Đổi mật khẩu</h1>
        <p class="mt-2 max-w-2xl text-slate-600">
          Form đổi mật khẩu tài khoản khách hàng qua backend Spring Boot.
        </p>
      </div>
      ...
      <div class="grid gap-6 lg:grid-cols-[260px_1fr]">
        ...
        <form class="rounded-2xl border border-avocado-100 bg-white p-6 shadow-sm" novalidate @submit.prevent="changePassword">
          <div class="grid gap-5">
            <label class="grid gap-2 text-sm font-bold text-slate-700">
              ...
              <span class="relative">
                ...
                <input v-model="form.currentPassword" type="password" autocomplete="current-password" class="w-full rounded-xl border px-12 py-3 outline-none transition focus:border-avocado-500 focus:ring-4 focus:ring-avocado-100" :class="errors.currentPassword ? 'border-red-300 bg-red-50/40' : 'border-slate-200'" />
              </span>
            ...
            <label class="grid gap-2 text-sm font-bold text-slate-700">
              ...
              <span class="relative">
                ...
                <input v-model="form.newPassword" type="password" autocomplete="new-password" class="w-full rounded-xl border px-12 py-3 outline-none transition focus:border-avocado-500 focus:ring-4 focus:ring-avocado-100" :class="errors.newPassword ? 'border-red-300 bg-red-50/40' : 'border-slate-200'" />
              </span>
            ...
            <label class="grid gap-2 text-sm font-bold text-slate-700">
              ...
              <span class="relative">
                <KeyRound class="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-avocado-700" />
                <input v-model="form.confirmPassword" type="password" autocomplete="new-password" class="w-full rounded-xl border px-12 py-3 outline-none transition focus:border-avocado-500 focus:ring-4 focus:ring-avocado-100" :class="errors.confirmPassword ? 'border-red-300 bg-red-50/40' : 'border-slate-200'" />
              </span>
          ...
          <div class="mt-8 flex justify-end">
            <button type="submit" class="rounded-xl bg-avocado-800 px-6 py-3 font-black text-white shadow-sm transition hover:bg-avocado-900 focus:outline-none focus:ring-4 focus:ring-avocado-100 disabled:cursor-not-allowed disabled:opacity-60" :disabled="isSaving">
